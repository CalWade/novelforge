...
def test_create_project_from_extract_alone_is_valid(fake_repo, monkeypatch):
    """from_extract alone (no from_preset, no blank_genre) is sufficient."""
    from src import bootstrap
    monkeypatch.setattr(
    ...
    # Verify project was created (blank genre stubs written first before extract ran)
